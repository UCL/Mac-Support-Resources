...
# Inform user what the script will do.
...
# Move the home folder to the new path and chown it to the new user. If your home
# folders are in a non-default location, please change /Users/ to the actual location
# of your home folders.
